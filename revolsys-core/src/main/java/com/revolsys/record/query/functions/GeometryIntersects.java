...
public class GeometryIntersects extends AbstractBinaryQueryValue implements Condition, Function {

  public static final String NAME = "ST_INTERSECTS";

  public GeometryIntersects(final QueryValue geometry1Value, final QueryValue geometry2Value) {
  ...
  @Override
  public GeometryIntersects clone() {
    return (GeometryIntersects)super.clone();
  }

  @Override
  public GeometryIntersects clone(final TableReference oldTable, final TableReference newTable) {
    return (GeometryIntersects)super.clone(oldTable, newTable);
  }

  @Override
  public boolean equals(final Object obj) {
    if (obj instanceof GeometryIntersects) {
      final GeometryIntersects condition = (GeometryIntersects)obj;
